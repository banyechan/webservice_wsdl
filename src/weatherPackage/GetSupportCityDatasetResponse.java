...
public class GetSupportCityDatasetResponse  implements java.io.Serializable {
    private weatherPackage.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult;

    public GetSupportCityDatasetResponse() {
    }

    public GetSupportCityDatasetResponse(
           weatherPackage.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult) {
     ...
     */
    public weatherPackage.GetSupportCityDatasetResponseGetSupportCityDatasetResult getGetSupportCityDatasetResult() {
        return getSupportCityDatasetResult;
    }
     ...
     */
    public void setGetSupportCityDatasetResult(weatherPackage.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult) {
        this.getSupportCityDatasetResult = getSupportCityDatasetResult;
    }
