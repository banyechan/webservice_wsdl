...
public class WeatherWSLocator extends org.apache.axis.client.Service implements weatherPackage.WeatherWS {
 ...
 */
    ...
    public weatherPackage.WeatherWSSoap_PortType getWeatherWSSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public weatherPackage.WeatherWSSoap_PortType getWeatherWSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            weatherPackage.WeatherWSSoap12Stub _stub = new weatherPackage.WeatherWSSoap12Stub(portAddress, this);
    ...
    public weatherPackage.WeatherWSSoap_PortType getWeatherWSSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public weatherPackage.WeatherWSSoap_PortType getWeatherWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            weatherPackage.WeatherWSSoap_BindingStub _stub = new weatherPackage.WeatherWSSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (weatherPackage.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                weatherPackage.WeatherWSSoap12Stub _stub = new weatherPackage.WeatherWSSoap12Stub(new java.net.URL(WeatherWSSoap12_address), this);
                _stub.setPortName(getWeatherWSSoap12WSDDServiceName());
                return _stub;
            }
            if (weatherPackage.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                weatherPackage.WeatherWSSoap_BindingStub _stub = new weatherPackage.WeatherWSSoap_BindingStub(new java.net.URL(WeatherWSSoap_address), this);
                _stub.setPortName(getWeatherWSSoapWSDDServiceName());
                return _stub;
            }
        }
